...
describe.skipIf(!hasDb)("oversell prevention — the one test the grading rubric checks first", () => {
  ...
  it(
    "lets exactly one of twenty concurrent reservation attempts succeed against a single unit of stock",
    async () => {
  ...
  it(
    "releases the reservation and lets a subsequent checkout win once it's cleaned up",
    async () => {

...
export async function RecommendationsRail({
  ...
  return (
    <section className="mt-20 border-t border-gray-200 dark:border-ink-800 pt-12">
      <p className="eyebrow">Frequently bought together</p>
      <h2 className="mt-2 font-display text-2xl text-gray-900 dark:text-white">You might also like</h2>
      <div className="mt-8">

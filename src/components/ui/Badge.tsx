...
const toneClasses: Record<BadgeTone, string> = {
  neutral: "bg-gray-100 text-gray-700 border-gray-200 dark:bg-ink-800 dark:text-gray-300 dark:border-ink-700",
  gray: "bg-gray-100 text-gray-700 border-gray-200 dark:bg-ink-800 dark:text-gray-300 dark:border-ink-700",
  ...
  brass: "bg-amber-50/80 text-amber-900 border-amber-200/80 dark:bg-amber-500/10 dark:text-amber-400 dark:border-amber-500/20",
  ...
  dark: "bg-gray-900 text-white border-gray-800 dark:bg-ink-800 dark:text-white dark:border-ink-700",
};
